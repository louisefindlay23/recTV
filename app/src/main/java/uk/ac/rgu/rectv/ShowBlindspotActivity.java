...
public class ShowBlindspotActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create same number of list entries as episodes in Season 1 (Adapted from Course Materials Week 6)
        List<ShowName> shownames = createShowNames(24);

        // Set up RecyclerView for Show Names (Adapted from Course Materials Week 6)
    ...
    // Create an ArrayList and for every list item add Episode string and a number increasing by one each time (Adapted from Course Materials Week 6)
    ...
    // Set and return the ShowName and EpisodeName (Adapted from Course Materials Week 6)
